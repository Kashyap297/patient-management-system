const TermsAndConditions = () => {
  return (
    <div className="flex-1 bg-white h-full p-8 md:p-12">
      <h2 className="text-2xl font-extrabold text-gray-800 tracking-tight mb-2">Terms & Conditions</h2>
      <p className="text-gray-500 text-sm mb-8">Please read these terms and conditions carefully.</p>

      <div className="bg-gray-50 rounded-xl p-6 md:p-8 border border-gray-100 h-[50vh] overflow-y-auto custom-scrollbar">
        <div className="prose prose-sm md:prose-base text-gray-600 max-w-none space-y-6">
          ...
          <h3 className="text-lg font-bold text-gray-800 mt-8 mb-4">1. Acceptance of Terms</h3>
          <p className="leading-relaxed">
          ...
          <h3 className="text-lg font-bold text-gray-800 mt-8 mb-4">2. User Responsibilities</h3>
          <p className="leading-relaxed">
