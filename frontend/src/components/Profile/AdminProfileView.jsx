  ...
  return (
    <div className="animate-slide-up">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <h3 className="text-2xl font-extrabold text-gray-800 tracking-tight">Profile Details</h3>
        <Link
          to="/admin/edit-profile"
          className="bg-[#10b981] text-white px-6 py-2.5 rounded-xl font-bold flex items-center shadow-sm hover:bg-green-600 hover:-translate-y-0.5 transition-all duration-300"
        >
