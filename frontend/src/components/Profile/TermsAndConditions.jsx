    ...
    <div className="min-h-screen bg-background p-6 md:p-8 space-y-8 relative overflow-hidden">
      ...
      <div className="relative z-10 animate-slide-up">
        <div className="glass p-8 md:p-10 rounded-3xl shadow-sm border border-white/50">
          <h3 className="text-3xl font-extrabold text-secondary tracking-tight mb-8">Terms & Condition</h3>
          ...
          <div className="mx-auto overflow-y-auto h-[500px] sm:h-[550px] custom-scroll bg-gray-50/50 rounded-3xl p-6 md:p-8 border border-gray-100 shadow-inner">
            ...
            <div className="space-y-6">
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">1. Usage of the System</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">2. Confidentiality</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">3. Data Accuracy</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">4. System Monitoring</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">5. Prohibited Activities</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">6. Limitation of Liability</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">7. Termination of Access</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold text-secondary mb-3">8. Amendments to the Terms</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  the system administrator at <span className="text-primary font-bold">admin@patientmanagement.com</span>.
                </p>
              </section>
            </div>
